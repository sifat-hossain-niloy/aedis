...
const serviceLinks = [
  ...
  { href: "/services/alarms", label: "Alarms" },
  { href: "/services/cctv", label: "CCTV" },
    ...
    <footer className="bg-brand-dark text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-5 group">
              <div className="w-9 h-9 bg-brand-accent rotate-45 flex items-center justify-center shrink-0">
                <Home className="-rotate-45 text-white w-4 h-4" />
              </div>
              <div className="leading-none">
                <span className="font-extrabold text-[14px] tracking-wide text-white block">
                  AEDIS SOLUTIONS
                </span>
                <span className="text-[10px] tracking-[0.2em] text-white/50 font-medium">
                  LTD
                </span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                aria-label="Aedis Solutions on Facebook"
                className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-brand-accent transition-colors"
              >
                <FacebookIcon className="w-4 h-4" />
              </a>
              <a
                href="#"
                aria-label="Aedis Solutions on Instagram"
                className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-brand-accent transition-colors"
              >
        ...
        <div className="border-t border-white/10 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/40">
          <p>
            © {new Date().getFullYear()} Aedis Solutions Ltd. All rights
            reserved. Company No. 16401111
          </p>
