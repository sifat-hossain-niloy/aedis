        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <AnimatedSection direction="left">
            <SectionHeading
              ...
              title="Serving London & Surrounding Areas"
              description="Based in London, we provide property maintenance services across the city. Get in touch to discuss your requirements — we'll confirm availability for your area."
            />
            ...
            <p className="mt-6 text-sm text-slate-500 flex items-center gap-2">
              ...
              Not sure if we cover your area? Just get in touch — we&apos;ll be happy to confirm.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection direction="right" delay={0.15}>
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg border border-slate-200 bg-slate-100 aspect-[4/3] flex items-center justify-center relative">
              ...
              <div className="text-center z-10 p-8">
                ...
                <p className="font-bold text-slate-700 text-lg">London-wide</p>
